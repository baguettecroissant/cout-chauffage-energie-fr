...
export function ViteUnDevisWidget() {
    ...
    useEffect(() => {
        ...
        w.vud_categorie_id = '156';

        const vud_js = document.createElement('script');
        vud_js.type = 'text/javascript';
        vud_js.async = true;
        vud_js.src = '//www.viteundevis.com/5bcb0bdde5/' + w.vud_partenaire_id + '/' + w.vud_categorie_id + '/';
    ...
    return (
        <div className="bg-white p-4 rounded-xl shadow-sm border border-zinc-200">
            <div id="v5bcb0bdde5d" className="min-h-[400px] flex items-center justify-center text-zinc-400">
